...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Out of the box, there isn't a limit for the number of Audit records that 
    | are kept for an Auditable model. To keep the records to a minimum, set 
    | the $auditThreshold property to a positive int of your choice.
    |
    */
    //'threshold' => 10,
];
